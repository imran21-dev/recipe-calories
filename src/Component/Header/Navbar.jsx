        ...
        <div className="flex justify-between items-center py-4">
            ...
            <ul className="flex gap-8  text-sm text-secondaryTextColor/70">
             ...
             <section className="flex w-1/3 items-center gap-3 justify-end">
                 <input className="bg-secondaryTextColor/5 placeholder:text-secondaryTextColor/70 bg-search-icon bg-no-repeat bg-bgSize text-secondaryTextColor/70  focus:outline-pColor/40 bg-left indent-2 py-2 px-8 rounded-full" type="text" placeholder="Search" />
